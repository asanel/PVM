...
namespace PVM.Migrations
{
    ...
    [Migration("20250118114747_AddManagerIdToAbsenceEntryMigration")]
    partial class AddManagerIdToAbsenceEntryMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PVM.Models.AbsenceEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AbsenceEntries");
                });

            modelBuilder.Entity("PVM.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PVM.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PVM.Models.Employee", b =>
                {
                    b.HasOne("PVM.Models.Address", "Address")
                        .WithOne()
                        .HasForeignKey("PVM.Models.Employee", "AddressId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
